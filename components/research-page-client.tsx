                ...
                <section className="relative overflow-hidden border-b border-border bg-gradient-to-b from-card to-background py-16 md:py-20">
                    ...
                    <div className="relative mx-auto max-w-5xl px-4">
                        ...
                        <AnimatedWrapper delay={100}>
                            <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Research</h1>
                        </AnimatedWrapper>
                            ...
                            <AnimatedWrapper delay={300}>
                                <div className="flex flex-wrap items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className={`rounded-lg border px-3 py-1.5 text-sm transition-all duration-300 ${!selectedTag
                                    ...
                                    {researchTags.map((tag, index) => (
                                        <button
                                            ...
                                            className={`rounded-lg border px-3 py-1.5 text-sm transition-all duration-300 ${selectedTag === tag
                                                    ? "border-primary/50 bg-primary/10 text-primary"
                                                    : "border-border text-muted-foreground hover:border-primary/30 hover:text-foreground"
                                                }`}
